...
// depth of the re-org.
//
// Both 'Confirmed' and 'Updates' channels contain the transaction details.
// However, there is no guarantee which channel will be read first if both are
// used.
//
...
type ConfirmationEvent struct {
	...
	// that contains the transaction, the index of the transaction within
	// the block, and the transaction itself.
	//
